    ...
    <section class="start-page parallax-background" id="home">
      ...
      <div class="content">
        <div class="text">
          ...
          <h1>Think about <br> your <span>concept</span> and we <span>do it<span>!</h1>
            <p>Wanna know more about us? just scroll!</p>
      ...
      <section class="about-us" id="about-us">
        ...
        <h1>ABOUT US</h1>
        <hr/>
        <p class="title">InDesk berdiri pada Oktober 2019. Seiring dengan pertumbuhan dan kebutuhan client dibidang digital, kami medirikan InDesk sebagai perusahaan yang memilliki layanan di bidang Pengembangan Aplikasi Web, Mobile dan UI UX. Saat ini kami meiliki layanan untuk setiap bisnis yang ingin mengembangkan bisnis mereka dari segi Design dan Digital. Dengan tim yang lengkap, dapat memberikan solusi untuk keperluan bisnis Anda.</p>
